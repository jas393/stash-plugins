...
Various plugins adding additionnal statistics on the stats page of stash.
...
The coordinates may be a bit off for some countries, you can correct them in the code if needed.
